...
var MapsLib = {
  ...
  polygon2TableID:    "1P_kShjdBdAMnOXCp0NtSrOd-Ag0DBNqMcbdRGloe", //Thematic map layer of selected CT school districts
  ...
  googleApiKey:       "AIzaSyAKFTwKJ9nT1C-1kys9Jr0tmi2q6opXHfg",
  ...
  searchRadius:       200,            //in meters ~ 1/2 mile
  ...
  //-----custom filters for point data layer
    ...
    var tempWhereClause = [];
    if ( $("#cbType1").is(':checked')) whereClause += " AND " + type_column + "> 0"
